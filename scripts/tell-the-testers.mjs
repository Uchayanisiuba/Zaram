...
function compose(r) {
  ...
  const body = [
    ...
    '',
    'When something goes wrong — and in an alpha something will — Settings → Help → Report a problem copies what I need. Paste it into a reply to this email, with what you expected and what happened instead. A reply that says "this was confusing" is as useful as one that says "this broke".',
    '',
