...
from services.text_processor import preprocess_text, chunk_text
...
# --- PERSONALITY ENGINE ---
# Maps Kokoro-style IDs to high-quality voices. 
# In the future, swap 'voice' to the actual Kokoro model path for Unreal integration.
PERSONALITIES = {
    "af_alexis": {
