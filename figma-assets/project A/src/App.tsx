...
export default function App() {
  ...
  return (
    <div style={{
      ...
      {/* Top navigation bar */}
      <TopNav workspace={workspace} onSearchOpen={() => setCommandOpen(true)} />
      ...
      <div style={{
        ...
        {!isLanding && (
          <LeftRail workspace={workspace} onNavigate={navigate} />
        )}
        ...
        <main style={{
          ...
          {isLanding && <Landing onNavigate={id => navigate(id as WorkspaceId)} />}
          {workspace === 'build' && (
      ...
      {commandOpen && (
        <CommandPalette
          ...
          onNavigate={id => navigate(id as WorkspaceId)}
        />
      )}
    </div>
  )
