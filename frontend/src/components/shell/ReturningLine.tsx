    ...
    >
      ...
      {segments.map((segment) => (
        <button
          ...
          type="button"
          onClick={() => go(segment)}
          className="rounded px-1.5 py-0 transition-colors hover:text-[var(--color-text)] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[var(--color-cyan)]"
          style={{
            color: 'inherit',
